package com.grandfatherpikhto.lessonblegatt01.ui
...
import com.grandfatherpikhto.lessonblegatt01.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        BleManager(this).let {
            lifecycle.addObserver(it)
            (application as GattApplication).bleManager = it
            _bleManager = it
        }
            ...
            getString(currentDevicePreference, null)?.let { address ->
                ...
                bleManager.getBluetoothDevice(address)?.let { device ->
                    ...
                    findNavController(R.id.nav_host_fragment_content_main)
                        .navigate(R.id.action_scanFragment_to_gattFragment)
                }
            }
        }
    }
